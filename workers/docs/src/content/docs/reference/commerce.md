...
is no correction pass; and don't treat product ids as stable across an edit —
they're stable across time and unstable across a change, because a change is a
re-create.
:::
