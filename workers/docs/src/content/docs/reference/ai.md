...
other value (including unset) means on, so no typo can accidentally _disable_ AI—only spell "off" correctly in more than one way. The failure this avoids is a
