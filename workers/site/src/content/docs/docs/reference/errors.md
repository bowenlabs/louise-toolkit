---
title: errors
description: "@louisecms/core/errors — LouiseError and its typed subclasses."
sidebar:
  order: 7
---

```ts
import { LouiseError, LouiseValidationError } from "@louisecms/core/errors";
```
...
| `LouiseEmailError` | `EMAIL_ERROR` | [`/email`](/docs/reference/email/) |
| `LouiseSessionError` | `SESSION_ERROR` | session primitives |
| `LouiseQueueError` | `QUEUE_ERROR` | [`/queues`](/docs/reference/queues/) |
| `LouiseCmsError` | `CMS_ERROR` | [`/cms`](/docs/reference/cms/) |
...
```ts
import { LouiseValidationError } from "@louisecms/core/errors";
