...
export interface GenerateSchemaOptions {
   ...
   * DECISIONS.md + `@louisecms/core/migrations`) a consuming site excludes
...
export function generateSchemaSource(
  ...
  return [
    ...
    ...(needsJsonValue ? ['import type { JsonValue } from "@louisecms/core/cms";'] : []),
