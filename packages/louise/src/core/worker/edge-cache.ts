...
export interface EdgeCacheConfig {
   ...
   * always run the handler—for example, an authenticated editor whose render is
...
export function withEdgeCache<Env = unknown>(
  ...
  // global merge over @cloudflare/workers-types', so reach it through a cast—same
  // lib.dom clash the site's env.d.ts re-declares around.
