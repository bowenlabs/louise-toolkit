 ...
 * this cheap: the caller passes the box, not a guess. Requests 2× for retina—a
 * 120 px tile asks for 240 px, which is still ~1% of a camera master.
 *
 ...
 *
 * Inputs that aren't HTTP or HTTPS URLs (relative paths, `data:` URLs, an empty string) pass
